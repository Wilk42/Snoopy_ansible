...
def parserow(netstatDatastr):
    ...
    tmpLocal = netstatData[3].split(':')
    #Split the ForeignIP/Port into a list
    tmpForeign = netstatData[4].split(':')
...
tmpDict1 = {}
#tmpDict1[] = entry1List
netstatJSON["listeners"] = json.dumps(entry1List)

#print tmplist
#print json.loads(netstat)[0]

pprint.pprint (netstatJSON)
